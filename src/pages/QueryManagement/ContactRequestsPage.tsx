...
const ContactRequestsPage: React.FC = () => {
  ...
  const products = [
    ...
    { label: "FDP Application", value: "application" },
    { label: "Request A Callback Form", value: "support" },
    { label: "Feedback", value: "coursefeedback" },
    { label: "Support Request", value: "studentsupport" },
  ];
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        const baseUrl = `${process.env.REACT_APP_API_BASE_URL}/courses/courses-list-2/`;

        const url =
          selectedProduct === "application" ? `${baseUrl}?category=2` : baseUrl;
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [selectedProduct, startDate, endDate, selectedCourseId]);
  ...
  }>("/queries/forms/submissions-2/", queryParams);
  ...
  const handleExportCSV = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/queries/forms/submissions-2/`,
        {
          params: exportParams,
          responseType: "blob",
          headers: {
      ...
      link.href = url;
      link.download = `contact_requests_${
  ...
  return (
    <div className="admin_panel">
      ...
      <div
        className="Breadcrumbs filter_query"
      ...
      >
        ...
        >
          <div className="date_grp" style={{ flex: "0 0 auto" }}>
            <input
              type="date"
          ...
          <div className="FiltersDay" style={{ flex: "0 0 auto" }}>
            <div className="FiltersButton">
              <div className="LastWrappFilter" style={{ width: "180px" }}>
                <button
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>{selectedSubmission?.name || "N/A"}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="row">
            ...
            {selectedSubmission?.form_type === "coursefeedback" && (
              <div className="col-md-6">
                <div className="form-group mb-3">
                  ...
                  <div className="star-rating">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <span
                        ...
                        style={{
                          color:
                            star <= (selectedSubmission?.rating || 0)
                              ? "#ffc107"
                              : "#e4e5e9",
                          fontSize: "24px",
                          marginRight: "5px",
            ...
            {selectedSubmission?.form_type === "application" && (
              <>
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    <label className="form-label">Conference Code</label>
                    <p className="form-control-plaintext">
                      {selectedSubmission?.conference_code || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    <label className="form-label">Attend Location</label>
                    <p className="form-control-plaintext">
                      {selectedSubmission?.attend_location || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <p className="form-control-plaintext">
                      {selectedSubmission?.institute_name || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <p className="form-control-plaintext">
                      {selectedSubmission?.address || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <p className="form-control-plaintext">
                      {selectedSubmission?.designation || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    <label className="form-label">Involved in Teaching</label>
                    <p className="form-control-plaintext">
                      {selectedSubmission?.involved_in_teaching === undefined ||
                      selectedSubmission?.involved_in_teaching === null
                        ? "N/A"
                        : selectedSubmission?.involved_in_teaching
                        ? "Yes"
                        : "No"}
                    </p>
                  </div>
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    <label className="form-label">How Heard</label>
                    <p className="form-control-plaintext">
                      {selectedSubmission?.how_heard || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                    ...
                    <p
                      className={`form-control-plaintext ${
                        selectedSubmission?.payment_status === "paid"
                          ? "text-success"
                          : selectedSubmission?.payment_status === "unpaid"
                          ? "text-danger"
                          : ""
                      }`}
                    >
                      {selectedSubmission?.payment_status || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <p className="form-control-plaintext">
                      {selectedSubmission?.document ? (
                        <a
                          href={selectedSubmission.document}
                          target="_blank"
