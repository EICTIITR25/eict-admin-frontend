...
const AddImageModal: React.FC<AddImageModalProps> = ({
  ...
  useEscToClose(showImageModal, () => setShowImageModal(false));
  const { form, setForm, isFieldsEmpty } = useDynamicForm(defaultForm);
    ...
    >
      <Modal.Body>
        ...
        >
          ...
          <h3>Supported file formats : .jpg, .png</h3>
          <p>Select multiple images from your local storage.</p>
        </div>
